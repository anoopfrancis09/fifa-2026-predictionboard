...
-- 9) Admin can edit an upcoming match. Existing predictions remain linked to the match.
...
-- 10) Admin can delete an upcoming match. Existing stakes are refunded before deletion.
...
-- 11) Public finished-match results with money masked for other users.
...
-- 13) Make your first admin after signing up in the app:
